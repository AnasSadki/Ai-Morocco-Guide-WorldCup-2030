        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {images.map((image, index) => (
            <div key={index} className="overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              {index === 3 && (
                <div className="p-4 bg-white">
                  <h3 className="text-lg font-semibold text-gray-900 text-center">Sfenj</h3>
                </div>
              )}
              {index === 4 && (
                <div className="p-4 bg-white">
                  <h3 className="text-lg font-semibold text-gray-900 text-center">Beef Tagine with Prunes</h3>
                </div>
              )}
              {index === 5 && (
                <div className="p-4 bg-white">
              ...
              {index === 11 && (
                <div className="p-4 bg-white">
                  <h3 className="text-lg font-semibold text-gray-900 text-center">Couscous</h3>
                </div>
              )}
            </div>
          ))}
